...
public class ObserverY_Mk2_Left_NormalEnemy : NormalEnemy
{
    [Header("레이저의 크기")]
    [SerializeField]
    ...
    protected override void InsertQueue()
    {
        ...
        SetAttackDir(AttackDir.RIGHT);
        PoolManager.Instance.InsertQueue(this.gameObject, PoolManager.EnemyType.OBSERVERYMK2_LEFT);
    }
}
